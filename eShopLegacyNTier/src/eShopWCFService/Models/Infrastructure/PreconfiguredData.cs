...
namespace eShopWCFService.Models.Infrastructure
{
    public static class PreconfiguredData
    {
        ...
        public static IEnumerable<DiscountItem> GetPreconfiguredDiscountItems()
        {
            ...
            {
                new DiscountItem { Start = new DateTime(2017,  9, 18), End = new DateTime(2017,  9, 21), Size = 0.30f },
                new DiscountItem { Start = new DateTime(2017,  9, 22), End = new DateTime(2017,  9, 26), Size = 0.25f },
                new DiscountItem { Start = new DateTime(2017,  9, 27), End = new DateTime(2017,  9, 30), Size = 0.10f },
                new DiscountItem { Start = new DateTime(2017, 10,  5), End = new DateTime(2017, 10, 20), Size = 0.50f },
                new DiscountItem { Start = new DateTime(2017, 11, 13), End = new DateTime(2017, 11, 25), Size = 0.30f },
