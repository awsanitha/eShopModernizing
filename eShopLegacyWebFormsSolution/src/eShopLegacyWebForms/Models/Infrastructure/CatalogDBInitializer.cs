...
namespace eShopLegacyWebForms.Models.Infrastructure
{
    public class CatalogDBInitializer
    {
        ...
        public void Seed(CatalogDBContext context)
        {
            ...
            // Only seed if no catalog types exist
        ...
        {
            // The sequence name comes from constant strings defined in this class, not from user input
            // Using ExecuteSqlRaw with a format-safe approach for sequence queries
            int result = 0;
