...
namespace eShopLegacyWebForms.Models.Infrastructure
{
    public class CatalogDBInitializer
    {
            ...
            IWebHostEnvironment hostingEnvironment)
        {
            ...
            _useCustomizationData = _configuration.GetValue<bool>("UseCustomizationData");
        }
        ...
        public void Initialize(CatalogDBContext context)
        {
            ...
            if (context.CatalogTypes.Any() || context.CatalogBrands.Any() || context.CatalogItems.Any())
            {
        ...
        {
            var scriptFilePath = Path.Combine(_hostingEnvironment.ContentRootPath, scriptFile.Replace('\\', '/'));
