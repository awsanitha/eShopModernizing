...
namespace eShopLegacyWebForms.Models.Infrastructure
{
    public class CatalogDBInitializer
    {
            ...
            IWebHostEnvironment env)
        {
            ...
            this.env = env;
            useCustomizationData = bool.Parse(configuration["AppSettings:UseCustomizationData"] ?? "false");
        }
        ...
        {
            // Note: uses AppDomain.CurrentDomain.BaseDirectory as fallback
        ...
        static CatalogItem? CreateCatalogItem(string[] column, string[] headers,
        ...
        private void AddCatalogItemPictures()
        {
            ...
            System.IO.Compression.ZipFile.ExtractToDirectory(zipFileCatalogItemPictures, picturePath.ToString());
        }
    }
}
