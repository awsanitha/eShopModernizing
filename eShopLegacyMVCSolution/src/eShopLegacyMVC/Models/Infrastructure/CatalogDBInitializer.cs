...
namespace eShopLegacyMVC.Models.Infrastructure
{
    public class CatalogDBInitializer
    {
        ...
        {
            throw new NotImplementedException("contentRootPath not available in static method");
        }

        private IEnumerable<CatalogBrand> GetCatalogBrandsFromFileInternal()
        {
